...
from app.api import health_router, validation_router, chatbot_router, text_generation_router, sentiment_router, summarization_router, translation_router, quiz_router
...
app.include_router(text_generation_router.router)
